...
insert into nbp_bolnica values
    (01, 'Citadel', 'Glavna 1', 'Minas Tirith'),
    (02, 'Imladris', 'Glavna 1', 'Rivendell'),
    (03, 'Meduseld', 'Glavna 1', 'Edoras'),
    (04, 'Rhovanion', 'Glavna 1', 'Mirkwood'),
    (05, 'Prancing Pony', 'Glavna 1', 'Bree'),
    (06, 'Armenelos', 'Glavna 1', 'Numenor'),
    (07, 'Valinor', 'Glavna 1', 'Tirion');

drop table nbp_pacijent;
drop table nbp_termin;
drop table nbp_admin;
drop table nbp_lijecnik;
drop table nbp_bolnica;
drop table nbp_bolnica_pretraga;
drop table nbp_susjedi;
drop table nbp_pretraga;