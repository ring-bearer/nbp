...
{
    $st = $db->prepare(
        'CREATE TABLE IF NOT EXISTS nbp_prijedlozi_termin(
...
catch( PDOException $e ) { exit( "PDO error za nbp_termin_prijedlozi: " . $e->getMessage() ); }

echo "Napravio tablicu nbp_termin_prijedlozi.<br>";
...
try
{
    $st = $db->prepare( 'INSERT INTO nbp_lijecnik(oib,ime,prezime,datum_rodjenja,adresa_ambulante,mjesto_ambulante,id_bolnice,password_hash) VALUES (:oib,:ime,:prezime,:datum_rodjenja,:adresa_ambulante,:mjesto_ambulante,:id_bolnice,:password)');

    $st->execute( array( 'oib' => '10000444444', 'ime' => 'Gandalf', 'prezime' => 'Mithrandir', 'datum_rodjenja' => '1940-07-02', 'adresa_ambulante' => 'Glavna 8', 'mjesto_ambulante' => 'Zagreb', 'id_bolnice' => '1', 'password' => password_hash( 'gandalf123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000291105', 'ime' => 'Aragorn', 'prezime' => 'Elessar', 'datum_rodjenja' => '1980-07-02', 'adresa_ambulante' => 'Glavna 1', 'mjesto_ambulante' => 'Slavonski Brod', 'id_bolnice' => '4', 'password' => password_hash( 'aragorn123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000062905', 'ime' => 'Legolas', 'prezime' => 'Thranduilion', 'datum_rodjenja' => '1970-07-02', 'adresa_ambulante' => 'Glavna 7', 'mjesto_ambulante' => 'Bjelovar', 'id_bolnice' => '14', 'password' => password_hash( 'legolas123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000999919', 'ime' => 'Theoden', 'prezime' => 'Ednew', 'datum_rodjenja' => '1960-07-02', 'adresa_ambulante' => 'Glavna 5', 'mjesto_ambulante' => 'Slavonski Brod', 'id_bolnice' => '17', 'password' => password_hash( 'theoden123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000857999', 'ime' => 'Arwen', 'prezime' => 'Undomiel', 'datum_rodjenja' => '1970-07-02', 'adresa_ambulante' => 'Glavna 4', 'mjesto_ambulante' => 'Bjelovar', 'id_bolnice' => '20', 'password' => password_hash( 'arwen123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000893743', 'ime' => 'Denethor', 'prezime' => 'Ecthelion', 'datum_rodjenja' => '1950-07-02', 'adresa_ambulante' => 'Glavna 9', 'mjesto_ambulante' => 'Split', 'id_bolnice' => '28', 'password' => password_hash( 'denethor123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000891233', 'ime' => 'Tom', 'prezime' => 'Bombadil', 'datum_rodjenja' =>'1940-07-02', 'adresa_ambulante' => 'Glavna 2', 'mjesto_ambulante' => 'Split', 'id_bolnice' => '56', 'password' => password_hash( 'tom123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000213905', 'ime' => 'Elendil', 'prezime' => 'Voronda', 'datum_rodjenja' => '1960-07-02', 'adresa_ambulante' => 'Glavna 11', 'mjesto_ambulante' => 'Zagreb', 'id_bolnice' => '70', 'password' => password_hash( 'elendil123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000294736', 'ime' => 'Feanor', 'prezime' => 'Curufinwe', 'datum_rodjenja' => '1960-07-02', 'adresa_ambulante' => 'Glavna 12', 'mjesto_ambulante' => 'Bjelovar', 'id_bolnice' => '13', 'password' => password_hash( 'feanor123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000243905', 'ime' => 'Maedhros', 'prezime' => 'Nelyafinwe', 'datum_rodjenja' => '1980-07-02', 'adresa_ambulante' => 'Glavna 6', 'mjesto_ambulante' => 'Split', 'id_bolnice' => '27', 'password' => password_hash( 'maedhros123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000432043', 'ime' => 'Finwe', 'prezime' => 'Noldoran', 'datum_rodjenja' => '1940-07-02', 'adresa_ambulante' => 'Glavna 13', 'mjesto_ambulante' => 'Zagreb', 'id_bolnice' => '100', 'password' => password_hash( 'finwe123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000794735', 'ime' => 'Elrond', 'prezime' => 'Peredhel', 'datum_rodjenja' => '1940-07-02', 'adresa_ambulante' => 'Glavna 3', 'mjesto_ambulante' => 'Slavonski Brod', 'id_bolnice' => '114', 'password' => password_hash( 'elrond123', PASSWORD_DEFAULT )) );
...
try
{
    ...
    $st->execute( array( 'oib' => '10000338099', 'mbo' => '100338099', 'ime' => 'Frodo', 'prezime' => 'Baggins', 'datum_rodjenja' => '2000-07-02', 'adresa' => 'Glavna 1', 'mjesto' => 'Beli Manastir', 'oib_lijecnika' => '10000444444', 'password' => password_hash( 'frodo123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000917906', 'mbo' => '100917906', 'ime' => 'Samwise', 'prezime' => 'Gamgee', 'datum_rodjenja' => '1999-07-02', 'adresa' => 'Glavna 3', 'mjesto' => 'Senj', 'oib_lijecnika' => '10000891233', 'password' => password_hash( 'samwise123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000998713', 'mbo' => '100998713', 'ime' => 'Meriadoc', 'prezime' => 'Brandybuck', 'datum_rodjenja' => '1998-07-02', 'adresa' => 'Glavna 2', 'mjesto' => 'Biograd na Moru', 'oib_lijecnika' => '10000891233', 'password' => password_hash( 'meriadoc123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000395731', 'mbo' => '100395731', 'ime' => 'Peregrin', 'prezime' => 'Took', 'datum_rodjenja' => '2001-07-02', 'adresa' => 'Glavna 4', 'mjesto' => 'Ploče', 'oib_lijecnika' => '10000444444', 'password' => password_hash( 'peregrin123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000520909', 'mbo' => '100520909', 'ime' => 'Boromir', 'prezime' => 'Echtelion', 'datum_rodjenja' => '1980-07-02', 'adresa' => 'Glavna 5', 'mjesto' => 'Sisak', 'oib_lijecnika' => '10000291105', 'password' => password_hash( 'boromir123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000013006', 'mbo' => '100013006', 'ime' => 'Faramir', 'prezime' => 'Echtelion', 'datum_rodjenja' => '1990-07-02', 'adresa' => 'Glavna 5', 'mjesto' => 'Samobor', 'oib_lijecnika' => '10000893743', 'password' => password_hash( 'faramir123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000878383', 'mbo' => '100878383', 'ime' => 'Eowyn', 'prezime' => 'Eadig', 'datum_rodjenja' => '1990-07-02', 'adresa' => 'Glavna 7', 'mjesto' => 'Đakovo', 'oib_lijecnika' => '10000999919', 'password' => password_hash( 'eowyn123', PASSWORD_DEFAULT )) );
    $st->execute( array( 'oib' => '10000402929', 'mbo' => '100402929', 'ime' => 'Eomer', 'prezime' => 'Eadig', 'datum_rodjenja' => '1990-07-02', 'adresa' => 'Glavna 7', 'mjesto' => 'Split', 'oib_lijecnika' => '10000999919', 'password' => password_hash( 'eomer123', PASSWORD_DEFAULT )) );
